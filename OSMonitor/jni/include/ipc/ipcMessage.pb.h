...
const ipcAction ipcAction_MAX = LOGCAT_MAIN_R;
...
inline ::com::eolwral::osmonitor::ipc::ipcAction ipcData::action() const {
  // @@protoc_insertion_point(field_get:com.eolwral.osmonitor.ipc.ipcData.action)
...
inline void ipcData::set_action(::com::eolwral::osmonitor::ipc::ipcAction value) {
  assert(::com::eolwral::osmonitor::ipc::ipcAction_IsValid(value));
  set_has_action();
  action_ = value;
  // @@protoc_insertion_point(field_set:com.eolwral.osmonitor.ipc.ipcData.action)
}
...
inline const ::std::string& ipcData::payload(int index) const {
  // @@protoc_insertion_point(field_get:com.eolwral.osmonitor.ipc.ipcData.payload)
  return payload_.Get(index);
}
inline ::std::string* ipcData::mutable_payload(int index) {
  // @@protoc_insertion_point(field_mutable:com.eolwral.osmonitor.ipc.ipcData.payload)
  return payload_.Mutable(index);
}
inline void ipcData::set_payload(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:com.eolwral.osmonitor.ipc.ipcData.payload)
  payload_.Mutable(index)->assign(value);
}
inline void ipcData::set_payload(int index, const char* value) {
  payload_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:com.eolwral.osmonitor.ipc.ipcData.payload)
}
inline void ipcData::set_payload(int index, const void* value, size_t size) {
  payload_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:com.eolwral.osmonitor.ipc.ipcData.payload)
}
...
inline void ipcData::add_payload(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:com.eolwral.osmonitor.ipc.ipcData.payload)
}
inline void ipcData::add_payload(const char* value) {
  payload_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:com.eolwral.osmonitor.ipc.ipcData.payload)
}
inline void ipcData::add_payload(const void* value, size_t size) {
  payload_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:com.eolwral.osmonitor.ipc.ipcData.payload)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
ipcData::payload() const {
  // @@protoc_insertion_point(field_list:com.eolwral.osmonitor.ipc.ipcData.payload)
  return payload_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
ipcData::mutable_payload() {
  // @@protoc_insertion_point(field_mutable_list:com.eolwral.osmonitor.ipc.ipcData.payload)
  return &payload_;
}
...
inline ::com::eolwral::osmonitor::ipc::ipcMessage_ipcType ipcMessage::type() const {
  // @@protoc_insertion_point(field_get:com.eolwral.osmonitor.ipc.ipcMessage.type)
...
inline void ipcMessage::set_type(::com::eolwral::osmonitor::ipc::ipcMessage_ipcType value) {
  assert(::com::eolwral::osmonitor::ipc::ipcMessage_ipcType_IsValid(value));
  set_has_type();
  type_ = value;
  // @@protoc_insertion_point(field_set:com.eolwral.osmonitor.ipc.ipcMessage.type)
}
...
inline const ::com::eolwral::osmonitor::ipc::ipcData& ipcMessage::data(int index) const {
  // @@protoc_insertion_point(field_get:com.eolwral.osmonitor.ipc.ipcMessage.data)
  return data_.Get(index);
}
inline ::com::eolwral::osmonitor::ipc::ipcData* ipcMessage::mutable_data(int index) {
  // @@protoc_insertion_point(field_mutable:com.eolwral.osmonitor.ipc.ipcMessage.data)
  return data_.Mutable(index);
}
inline ::com::eolwral::osmonitor::ipc::ipcData* ipcMessage::add_data() {
  // @@protoc_insertion_point(field_add:com.eolwral.osmonitor.ipc.ipcMessage.data)
  return data_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::eolwral::osmonitor::ipc::ipcData >&
ipcMessage::data() const {
  // @@protoc_insertion_point(field_list:com.eolwral.osmonitor.ipc.ipcMessage.data)
  return data_;
}
inline ::google::protobuf::RepeatedPtrField< ::com::eolwral::osmonitor::ipc::ipcData >*
ipcMessage::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:com.eolwral.osmonitor.ipc.ipcMessage.data)
  return &data_;
}
...
template <> struct is_proto_enum< ::com::eolwral::osmonitor::ipc::ipcMessage_ipcType> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::com::eolwral::osmonitor::ipc::ipcAction> : ::google::protobuf::internal::true_type {};
template <>
